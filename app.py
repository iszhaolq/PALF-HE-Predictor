...
st.markdown(
    ...
    Estimate the probability of new-onset hepatic encephalopathy using six routinely available admission laboratory measurements.
    </div>
    """,
    unsafe_allow_html=True,
)
...
st.markdown(
    ...
    <strong>Research use only.</strong> This estimate does not diagnose hepatic encephalopathy, recommend treatment, or replace clinical assessment.
    </div>
    """,
    unsafe_allow_html=True,
)
